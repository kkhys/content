...
[Karabiner-Elements](https://karabiner-elements.pqrs.org) を使って、[HHKB Professional HYBRID Type-S](https://amzn.asia/d/fNPTi3l) のキーボードをカスタマイズしている。
...
高機能なマウス [Logicool MX Master 3s](https://amzn.asia/d/1GNof5X) を活用するために、専用ソフトウェアの [Logi Options+](https://www.logicool.co.jp/ja-jp/software/logi-options-plus.html) を導入している。
