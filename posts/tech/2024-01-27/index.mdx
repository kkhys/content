---
title: フォントのこだわり
description: この Web サイトで使用している 5 種類のフォントについて書き連ねていく。
emoji: 🔠
category: Tech
tags: []
status: published
...
絵文字を置き換えると以下のようになる（Safari や iOS だと同じに見えるはず）。

<p className='mb-1'>🥰💀✌️🌴🐢🐐🍄⚽🍻👑📸😬👀🚨🏡🐦‍🔥🍋‍🟩🍄‍🟫🙂‍↕️🕊️🏆😻🌟🧿🍀🎨</p>

<p className='my-1'>↓</p>

<p className='font-emoji mt-1'>🥰💀✌️🌴🐢🐐🍄⚽🍻👑📸😬👀🚨🏡🐦‍🔥🍋‍🟩🍄‍🟫🙂‍↕️🕊️🏆😻🌟🧿🍀🎨🍜</p>
