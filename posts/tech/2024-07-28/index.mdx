...
お問い合わせ機能のレートリミットを設定したとき（[記事](/posts/p143t9d)）と同様にセキュリティ対策として IP アドレスは SHA-256 でハッシュ化してから Redis に保存する。
...
![Upstash の管理画面](/images/tech/2024-07-28/01.png "Upstash の管理画面")
